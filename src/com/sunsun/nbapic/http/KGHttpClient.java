...
import com.sunsun.nbapic.AppException;
import com.sunsun.nbapic.NbaPicApplication;
import com.sunsun.nbapic.logcat.KGLog;
...
public class KGHttpClient {
	...
	private static HttpClient createHttpClient(RequestPackage requestPackage) {
		...
		// cmwap设置代理
		boolean isCmwap = NetWorkUtil.isCmwap(NbaPicApplication.getInstance());
		if (isCmwap) {
	...
	public static String getUserAgent() {
		if (TextUtils.isEmpty(sUserAgent)) {
			PackageInfo pi = NbaPicApplication.getInstance().getPackageInfo();
