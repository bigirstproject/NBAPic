...
public class AnimationHelper {
	...
	public static Animation createAnimTopIn(Context context,
			AnimationListener listener) {
		Animation mAnimOut = AnimationUtils.loadAnimation(context,
				R.anim.common_top_in);
	...
	public static Animation createAnimTopOut(Context context,
			AnimationListener listener) {
		Animation mAnimIn = AnimationUtils.loadAnimation(context,
				R.anim.common_top_out);
	...
	public static Animation createAnimBottomIn(Context context,
			AnimationListener listener) {
		Animation mAnimIn = AnimationUtils.loadAnimation(context,
				R.anim.common_bottom_in);
		if (mAnimIn != null && listener != null) {
			mAnimIn.setAnimationListener(listener);
		}
		return mAnimIn;
	...
	public static Animation createAnimBottomOut(Context context,
			AnimationListener listener) {
		Animation mAnimOut = AnimationUtils.loadAnimation(context,
				R.anim.common_bottom_out);
		if (mAnimOut != null && listener != null) {
			mAnimOut.setAnimationListener(listener);
		}
		return mAnimOut;
